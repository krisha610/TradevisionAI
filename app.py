...
def is_market_open(ticker, info):
    ...
    if t.endswith(".NS") or t.endswith(".BO"):
        # Indian Markets (NSE/BSE): 9:15 AM - 3:30 PM IST (UTC+5.5)
...
<div style='background:rgba(15,23,42,0.6);backdrop-filter:blur(12px);
    ...
    for col_h,num_h,icon_h,title_h,desc_h,delay in [
        ...
        col_h.markdown(textwrap.dedent(f"""
...
market_status_badge = f"<span class='alert-badge badge-safe'>🟢 MARKET OPEN</span>" if market_is_open else f"<span class='alert-badge badge-danger'>🔴 MARKET CLOSED</span>"
